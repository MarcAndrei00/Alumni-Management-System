                    ...
                    <div class="container" data-aos="fade-up">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6" data-aos="fade-left">
                                ...
                                <p class="card-text"><small class="text-muted"><b>DATE: </b><?php echo $date; ?></small></p>
                                <p class="card-text"><small class="text-muted"><b>TIME: </b><?php echo $startTime; ?> To <?php echo $endTime; ?></small></p>
