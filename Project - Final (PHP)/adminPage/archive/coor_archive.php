                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="inline"><?php echo date('F j, Y, g:i A', strtotime($row['date_archived'])) ?></td>
                                            <?php
                                            echo "
                                                <td class='inline act'>
                                                    <div class='button'>
                                                        <a class='btn btn-success btn-sm archive' href='./restore_coor.php?id=$row[coor_id]' style='font-size: 11.8px;'>Restore</a>
                                                    </div>
                                                </td>
                                            "; ?>
                                        </tr>
