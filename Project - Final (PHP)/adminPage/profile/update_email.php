...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM admin WHERE admin_id=$account";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    ...
    $emailCheck = mysqli_query($conn, "SELECT * FROM admin WHERE email = '$inputEmail' AND admin_id != $admin_id");
    ...
    if (mysqli_num_rows($emailCheck) > 0) {
        ...
        // $sql = "UPDATE admin SET email='$inputEmail' WHERE admin_id = $admin_id";
        // $result = $conn->query($sql);
